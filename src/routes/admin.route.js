...
router.patch('/update-email',verifyAuthToken, updateEmailAdmin)
...
router.patch('/update-status',verifyAuthToken, updateStatusAdmin)
...
router.patch('/update-membership',verifyAuthToken, updateMembershipAdmin)
